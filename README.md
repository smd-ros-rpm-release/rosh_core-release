## rosh_core (indigo) - 1.0.7-0

The packages in the `rosh_core` repository were released into the `indigo` distro by running `/usr/bin/bloom-release rosh_core --track indigo --rosdistro indigo` on `Sun, 17 Aug 2014 21:25:35 -0000`
